...
openapi: '/openapi.json GET /merchant/payments/'
---

<Note>
  This endpoint retrieves a paginated list of payments, with powerful filtering capabilities to narrow down the results.
</Note>
