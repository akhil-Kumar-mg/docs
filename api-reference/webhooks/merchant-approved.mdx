...
```json Example Payload
{
    ...
    "data": {
        ...
        "merchant_legal_name": "TechStore Solutions Private Limited",
        "merchant_trade_name": "TechStore Online"
    }
}
```
...
<Tabs>
  ...
  <Tab title="Data Object Fields">
    ...
    <ParamField path="data.merchant_legal_name" type="string" required>
      Legal business name of the merchant as registered with authorities
      
      **Example**: `"TechStore Solutions Private Limited"`
    </ParamField>

    <ParamField path="data.merchant_trade_name" type="string" required>
