...
## Generating Credentials for Web Checkout & API Access

To begin using EximPe’s Web Checkout and APIs, you need to generate credentials — `client_id`, `client_secret` .
...
## If You Are a Payment Aggregator (PA)

If you're a PA receiving payments on behalf of your merchants:

1. **Add a Merchant**
   - Before you can make API calls on behalf of a merchant, you must first add them.
   - Refer to the [Adding Merchants](./adding-merchants.md) guide for details.
...
- ✅ [Add and Activate a Merchant](./adding-merchants.md)
- ✅ [Start Making API Calls](./api-reference.md)

If you need help at any point, reach out to [support@eximpe.com](mailto:support@eximpe.com).